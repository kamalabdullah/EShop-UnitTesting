...
var LogInService = /** @class */ (function () {
    ...
    LogInService.prototype.getUser = function (userName) {
        return this.http.get(_Shared_Constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].getUserUrl + userName)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return JSON.stringify(data); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
...
var ProductService = /** @class */ (function () {
    function ProductService(location, http) {
        this.location = location;
        this.http = http;
        this.httpOptions = {
    ...
    ProductService.prototype.submitUserProducts = function (userId, productIds) {
...
var GlobalsService = /** @class */ (function () {
    ...
    GlobalsService.prototype.pushToOrderList = function (product) {
    ...
    GlobalsService.prototype.concatToOrderList = function (productList) {
        if (this.orderedItemList == null) {
            this.orderedItemList = [];
        }
    ...
    GlobalsService.prototype.clearOrderList = function () {
        this.storage.set(_Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].orderListSessionKey, null);
        this.orderedItemList = null;
    };
    GlobalsService.prototype.setProductFilter = function (minPrice, maxPrice) {
    ...
    GlobalsService.prototype.getProductFilter = function () {
    ...
    GlobalsService.prototype.clearProductFilter = function () {
...
var LogInComponent = /** @class */ (function () {
    function LogInComponent(fb, logInService, global, route, router) {
        this.fb = fb;
    ...
    Object.defineProperty(LogInComponent.prototype, "userName", {
        get: function () { return this.angForm.get('userName'); },
        enumerable: true,
        configurable: true
    });
    LogInComponent.prototype.getUserByName = function () {
        var _this = this;
        this.logInService.getUser(this.userName.value).subscribe({
            next: function (userInfo) {
                _this.user = userInfo;
                if (_this.user != null) {
                    _this.errorMessage = '';
                    _this.global.setLoggedInUser(_this.user);
                    _this.global.orderedItemList = [];
                    _this.router.navigate(['/products']);
                }
                else {
                    _this.errorMessage = 'This user not found';
                }
            },
...
var NavMenuComponent = /** @class */ (function () {
    function NavMenuComponent(global, router) {
        this.global = global;
        this.router = router;
        this.ordersCount = 0;
...
var CartComponent = /** @class */ (function () {
    function CartComponent(global, router, productService, toastr) {
        this.global = global;
        this.router = router;
    ...
    CartComponent.prototype.ngOnInit = function () {
        ...
        if (this.orderProduct && this.orderProduct.length) {
            ...
            this.orderProduct.forEach(function (element) {
                element.count = groupedArray[element.id].length;
            });
            this.uniqOrderList = this.orderProduct.filter(function (elem, index, self) {
                return index === self.findIndex(function (t) { return (t.id === elem.id); });
            });
            this.uniqOrderList.forEach(function (element) {
                _this.totalAmount += element.price * element.count;
            });
        }
        this.options = this.toastr.toastrConfig;
    };
    CartComponent.prototype.deleteItemFromCart = function (itemId) {
        var _this = this;
        this.totalAmount = 0;
    ...
    CartComponent.prototype.submitUserProducts = function () {
        var _this = this;
        var productIds = this.uniqOrderList.map(function (_a) {
            var id = _a.id;
            return id;
        });
        this.productService.submitUserProducts(this.user.id, productIds).subscribe(function () {
            _this.openToast();
            _this.global.clearOrderList();
            _this.router.navigate(['/products']);
        });
    };
    CartComponent.prototype.openToast = function () {
        this.options.positionClass = 'toast-top-right';
        var opt = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this.options);
...
var FilterComponent = /** @class */ (function () {
    function FilterComponent(toastr, global, router) {
        this.toastr = toastr;
        this.global = global;
        this.router = router;
    ...
    FilterComponent.prototype.changeMin = function () {
        return +this.productFilter.minPrice;
    };
    FilterComponent.prototype.changeMax = function () {
...
var ProductDetailsComponent = /** @class */ (function () {
    function ProductDetailsComponent(productService, route, global, router) {
        this.productService = productService;
        this.route = route;
        this.global = global;
        this.router = router;
    ...
    ProductDetailsComponent.prototype.getProduct = function (id) {
        ...
        this.productService.getProductById(id).subscribe({
            next: function (producInfo) {
                _this.productDetails = producInfo;
                _this.oredersDetailsList.push(_this.productDetails);
            },
            error: function (err) { return _this.errorMessage = err; }
        });
    };
    ProductDetailsComponent.prototype.incrementCounter = function () {
        this.itemCount++;
        this.disableMinusButton = false;
        this.oredersDetailsList.push(this.productDetails);
    };
    ProductDetailsComponent.prototype.decrementCounter = function () {
        if (this.itemCount > 1) {
            this.itemCount--;
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(productService, global, router) {
        this.productService = productService;
        this.global = global;
        this.router = router;
        this.products = [];
...
/* harmony import */ var ngx_bootstrap_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-bootstrap-slider */ "./node_modules/ngx-bootstrap-slider/fesm5/ngx-bootstrap-slider.js");
